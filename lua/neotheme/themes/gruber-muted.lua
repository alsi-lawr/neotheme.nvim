local surface_deepest = "#0e0d0c"
local surface_dark = "#11100f"
local surface_base = "#181715"
local surface_raised = "#25221f"
local surface_selected = "#37312e"
local surface_border = "#443d38"
local surface_muted = "#554c46"
local surface_addition = "#30343a"
local surface_error = "#9f5553"
local text_primary = "#c8c1b8"
local text_bright = "#d9d1c7"
local text_strong = "#e8ded2"
local text_on_error = "#f3eadf"
local syntax_comment = "#ad835e"
local syntax_string = "#8da66a"
local syntax_keyword = "#c9ae68"
local syntax_function = "#8b99aa"
local syntax_type = "#8fa099"
local syntax_property = "#58616c"
